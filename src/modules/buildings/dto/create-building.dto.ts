...
export class CreateBuildingDto {
  @ApiProperty({ description: 'Building type', enum: BuildingType, example: BuildingType.RESIDENTIAL })
  @IsEnum(BuildingType)
  type!: BuildingType;
  ...
  @ApiProperty({ description: 'Site ID', example: 'c27caa13-3083-475f-9aa8-9c1219e7c989' })
  @IsString()
  @IsNotEmpty()
  siteId!: string;

  @ApiProperty({ description: 'Owner ID', example: '21020a7e-5395-4adb-a459-d0aa44b683d2' })
  @IsString()
  @IsNotEmpty()
  ownerId!: string;
}
